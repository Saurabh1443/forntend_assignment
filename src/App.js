...
function App() {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'first_name',
      sorter: (a, b) => b.first_name.length - a.first_name.length,
    ...
    },
    {
      ...
      render:(val,rec)=>{
        return <Tag color={val==true?"green":'red'}>{val==true?"True":"False"}</Tag>
      }
  ...
  return (
    ...
    return {
      ...
      dataSource={dataSource} bordered={true} columns={columns} rowClassName={className} />
      </Card>
    </div>
  );
}
